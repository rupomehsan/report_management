    ...
    <div id="report_uplode_body">
        ...
        <section id="heading" class="mt-3">
            ...
            <div class="unit_info">
                ...
                <div class="line d-flex flex-wrap justify-content-between">
                    <p>
                        ওয়ার্ড নং ও নাম : {{ ward_info?.no ?? "" }} ও
                        {{ ward_info?.title ?? "" }}
                    </p>
                    <p>পৌরসভা/ইউনিয়ন:</p>
                    <p class="w-25">
                        উপজেলা/থানা: {{ thana_info?.title ?? "" }}
                    </p>
                </div>
                <div class="line d-flex flex-wrap justify-content-between">
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat1?.how_many_groups_are_out
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat1?.how_many_have_been_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat1?.how_many_associate_members_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat2?.how_many_have_been_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat2?.how_many_were_give_dawat_rokon
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat2?.how_many_were_give_dawat_worker
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat2?.how_many_associate_members_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat3?.how_many_were_give_dawat
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat3?.how_many_associate_members_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.total_gono_songjog_group
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.how_many_have_been_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.how_many_associate_members_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.jela_mohanogor_declared_gonosonjog_group
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.jela_mohanogor_declared_gonosonjog_attended
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.jela_mohanogor_declared_gonosonjog_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    dawat4?.jela_mohanogor_declared_gonosonjog_associated_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.election_gono_songjog_group
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.election_how_many_have_been_invited
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.election_how_many_associate_members_created
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.other_gono_songjog_group
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        name="other_attended"
                                        :value="
                                            formatBangla(dawat4?.other_attended)
                                        "
                                        @change="
                                            data_upload(
                                                'ward-dawat4-gono-songjog-and-dawat-ovijan'
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.other_how_many_have_been_invited
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawat4?.other_how_many_associate_members_created
                                            )
                                        "
                                        @change="
                                            data_upload(
                    ...
                    <table class="text-center mb-2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{
                                        (department1?.teacher_rokon ?? null) !==
                                            null ||
                                        (department1?.teacher_worker ??
                                            null) !== null
                                            ? formatBangla(
                            ...
                            <tr>
                                ...
                                <td>
                                    {{
                                        (department1?.student_rokon ?? null) !==
                                            null ||
                                        (department1?.student_worker ??
                                            null) !== null
                                            ? formatBangla(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department1?.quran_learning_total_group
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department1?.quran_learning_total_students
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department1?.total_forkania_madrasah
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department1?.total_moktob_students
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department1?.total_forkania_madrasah_students
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td class="width-30">
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department1?.how_much_learned_sohih_tilawat
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                        ...
                                        <div class="parent_popup">
                                            <div class="d-flex">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            department1?.how_much_invited_man
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                                ...
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            department1?.how_much_invited_woman
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                        ...
                                        <div class="parent_popup">
                                            <div class="d-flex">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            department1?.how_much_been_associated_man
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                                ...
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            department1?.how_much_been_associated_woman
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department1?.total_muallim_woman
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department1?.total_muallim_increased_man
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department1?.total_muallim_increased_woman
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <th class="width-20">
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.govment_calculated_village_amount
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.govment_calculated_moholla_amount
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.total_village_committee
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.total_moholla_committee
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.total_village_committee_increased
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.total_moholla_committee_increased
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.special_dawat_included_village
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.special_dawat_included_moholla
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.special_dawat_included_village_increased
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department2?.special_dawat_included_moholla_increased
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                ...
                                <tr>
                                    ...
                                    <td class="width-30">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department2?.how_many_been_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <tr>
                                    ...
                                    <td class="width-30">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department2?.how_many_associated_created
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department3?.how_many_young_been_invited
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department3?.how_many_young_been_associated
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department3?.total_young_committee
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department3?.total_young_committee_increased
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department3?.total_new_club_increased
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department3?.stablished_club_total_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department3?.stablished_club_total_increased
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.political_and_special_invited
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.political_and_special_been_associated
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.political_and_special_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.pesha_jibi_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.pesha_jibi_been_associated
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.olama_masayekh_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.olama_masayekh_been_associated
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.olama_masayekh_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.sromo_jibi_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department4?.sromo_jibi_been_associated
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.prantik_jonogosti_invited
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.prantik_jonogosti_been_associated
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.prantik_jonogosti_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.vinno_dormalombi_invited
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.vinno_dormalombi_been_associated
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        <div class="parent_popup">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        department4?.vinno_dormalombi_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department5?.total_attended_family
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department5?.how_many_new_family_invited
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.total_mosjid_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.general_dawah_center
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.general_dawah_center_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.dawat_included_mosjid
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.dawat_included_mosjid_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department6?.mosjid_wise_information_center
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department6?.general_information_center
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department6?.mosjid_wise_information_center_increase
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    department6?.general_information_center_increase
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.mosjid_wise_dawah_center
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                department6?.mosjid_wise_dawah_center_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                    ...
                    <p class="fw-bold fs-6 width-60">
                        ...
                        <span>
                            <input
                                ...
                                :value="
                                    formatBangla(department7?.total_well_known)
                                "
                                @change="
                                    data_upload(
                    ...
                    <p class="fw-bold fs-6 width-40">
                        ...
                        <span>
                            <input
                                name="total_attended"
                                :value="
                                    formatBangla(department7?.total_attended)
                                "
                                @change="
                                    data_upload(
                                        'ward-department7-dawat-in-technology'
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.total_pathagar
                                        )
                                    "
                                    @change="
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.total_pathagar_increase
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.ward_book_sales_center
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.ward_book_sales_center_increase
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.books_in_pathagar
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.books_in_pathagar_increase
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.ward_book_sales
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.ward_book_sales_increase
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.book_distribution
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            dawah_prokashona?.book_distribution_increase
                                        )
                                    "
                                    @change="
                                        data_upload('ward-dawah-and-prokashona')
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.soft_copy_book_distribution
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.soft_copy_book_distribution_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.unit_book_distribution_center
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.unit_book_distribution_center_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.dawat_link_distribution
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.dawat_link_distribution_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.unit_book_distribution
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <td>
                                <div class="parent_popup">
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                dawah_prokashona?.unit_book_distribution_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                kormosuci?.unit_masik_sadaron_sova_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td class="font-13">
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    kormosuci?.alochona_sova_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    kormosuci?.sudhi_somabesh_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td class="font-13">
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_kormosuci.alochona_sova
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_kormosuci.sudhi_somabesh
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                kormosuci?.siratunnabi_mahfil_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_kormosuci.siratunnabi_mahfil
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                                ...
                                <td class="font-13">
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    kormosuci?.dawati_jonosova_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td class="font-13">
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_kormosuci.dawati_jonosova
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    kormosuci?.kirat_protijogita_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    kormosuci?.hamd_nat_protijogita_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_kormosuci.kirat_protijogita
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_kormosuci.hamd_nat_protijogita
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present?.songothon1_rokon_previous ??
                                                    ""
                                            )
                                        }}
                                        <popup
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present?.songothon1_rokon_present ??
                                                    ""
                                            )
                                        }}
                                        <popup
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present?.songothon1_worker_previous ??
                                                    ""
                                            )
                                        }}
                                        <popup
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present?.songothon1_worker_present ??
                                                    ""
                                            )
                                        }}
                                        <popup
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon2_associate_member_man_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon2_associate_member_man_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon2?.associate_member_man_briddhi
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon2?.associate_member_man_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon2_associate_member_woman_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon2_associate_member_woman_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon2?.associate_member_woman_briddhi
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon2?.associate_member_woman_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.women_rokon_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.women_kormi_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.women_associate_member_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.women_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.women_associate_member_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_rokon_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_rokon_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_rokon_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_kormi_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_kormi_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_kormi_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_associate_member_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.sromojibi_associate_member_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.ulama_rokon_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.ulama_kormi_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.ulama_associate_member_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.ulama_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.ulama_associate_member_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present
                                                ?.songothon3_pesha_jibi_previous
                                                ?.total_rokon ?? ""
                                        )
                                    }}
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_rokon_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_rokon_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_rokon_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_kormi_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_kormi_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_kormi_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_associate_member_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.pesha_jibi_associate_member_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.jubo_rokon_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.jubo_kormi_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.jubo_associate_member_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.jubo_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.jubo_associate_member_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present
                                                    ?.songothon3_vinno_dormalombi_previous
                                                    ?.total_kormi ?? ""
                                            )
                                        }}
                                        <popup
                                ...
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present
                                                    ?.songothon3_vinno_dormalombi_present
                                                    ?.total_kormi ?? ""
                                            )
                                        }}
                                        <popup
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon3?.vinno_dormalombi_kormi_increase
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.vinno_dormalombi_kormi_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon3?.vinno_dormalombi_kormi_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon3?.vinno_dormalombi_associate_member_increase
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon3?.vinno_dormalombi_associate_member_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon3?.vinno_dormalombi_associate_member_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_general_unit_men_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_general_unit_men_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_men_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_men_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_men_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_general_unit_women_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_general_unit_women_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_women_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_women_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.general_unit_women_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_ulama_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_ulama_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.ulama_unit_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_peshajibi_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_peshajibi_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.peshajibi_unit_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.peshajibi_unit_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.peshajibi_unit_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_sromik_kollyan_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_sromik_kollyan_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.sromik_kollyan_unit_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.sromik_kollyan_unit_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.sromik_kollyan_unit_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_jubo_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_jubo_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_media_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon4_media_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon4?.media_unit_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon5_dawati_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon5_dawati_unit_present ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon5?.dawati_unit_increase
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{
                                        formatBangla(
                                            previous_present?.songothon5_paribarik_unit_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    <div class="parent_popup">
                                        ...
                                        {{
                                            formatBangla(
                                                previous_present?.songothon5_paribarik_unit_present ??
                                                    ""
                                            )
                                        }}
                                        <popup
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon5?.paribarik_unit_increase
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon5?.paribarik_unit_gatti
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon5?.paribarik_unit_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_man_member
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_women_member
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_man_associate
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_women_associate
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_man_worker
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon6?.Joined_student_women_worker
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        songothon7?.ward_sovapotir_sofor
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        songothon7?.word_sura_sodosso_sofor
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                        ...
                                        <td>
                                            <div class="parent_popup">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            songothon8?.associate_member_total
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                        ...
                                        <td>
                                            <div class="parent_popup">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            songothon8?.associate_member_total_iyanot_amounts
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                        ...
                                        <td>
                                            <div class="parent_popup">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            songothon8?.sudi_total_iyanot_amounts
                                                        )
                                                    "
                                                    @change="
                                                        data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.word_sura_boithok_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.kormoporishod_boithok_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.team_boithok_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.word_sura_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.kormoporishod_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.team_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon9?.word_boithok_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_songothon9.word_boithok
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon9?.masik_sodosso_boithok_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_songothon9.masik_sodosso_boithok
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                songothon9?.unit_kormi_boithok_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.unit_kormi_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.ulama_somabesh_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.jubok_somabesh_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    songothon9?.sromik_somabesh_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.ulama_somabesh
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.jubok_somabesh
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_songothon9.sromik_somabesh
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                proshikkhon1?.unit_tarbiati_boithok_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_proshikkhon1.unit_tarbiati_boithok
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                proshikkhon1?.ward_kormi_sikkha_boithok_target
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_proshikkhon1.ward_kormi_sikkha_boithok
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon1?.urdhotono_sikkha_shibir_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon1?.urdhotono_sikkha_boithok_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.urdhotono_sikkha_shibir
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.urdhotono_sikkha_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon1?.gono_sikkha_boithok_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon1?.gono_noisho_ibadot_target
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.gono_sikkha_boithok
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.gono_noisho_ibadot
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon1?.alochona_chokro_group
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_proshikkhon1.alochona_chokro
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.darsul_quran
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    average_proshikkhon1.sohih_tilawat
                                                )
                                            "
                                            @change="
                                                average_data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon2?.shomajkormo_uposthiti
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon2?.financial_management_uposthiti
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon2?.english_language_uposthiti
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    proshikkhon2?.arabic_language_uposthiti
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                proshikkhon2?.trade_oriented_technical_training_uposthiti
                                            )
                                        "
                                        @change="
                                            data_upload(
                ...
                <div class="personal_shamajik_kaj mb-2">
                    ...
                    <table class="text-center mb-1">
                        <tbody>
                            <tr>
                                <td class="text-start px-2">
                                    মোট কতজন ব্যক্তিগত উদ্যোগে সামাজিক কাজ
                                    করেছেন
                                </td>
                                <td class="width-20">
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba1?.how_many_people_did
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td class="width-20">
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba1?.service_received_total
                                                )
                                            "
                                            @change="
                                                data_upload(
                        ...
                        <tbody>
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            shomajsheba2?.number_of_general_service_teams
                                        )
                                    "
                                    @change="
                                        data_upload(
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            shomajsheba2?.number_of_technical_service_teams
                                        )
                                    "
                                    @change="
                                        data_upload(
                            ...
                            <td>
                                <input
                                    ...
                                    :value="
                                        formatBangla(
                                            shomajsheba2?.number_of_volunteer_teams
                                        )
                                    "
                                    @change="
                                        data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                shomajsheba2?.minor_unnoyonmulok_kaj
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.technical_services_prodan_kotojonke
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.online_services_prodan_kotojonke
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.shamajik_birodh_mimangsha
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.public_awareness_programs
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.porishkar_poricchonnota_ovijan
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.moshok_nidhon_ovijan
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.vinnodhormabolombider_service_prodan_kotojon
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.vinnodhormabolombider_service_prodan_kotojonke
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.mayeter_gosol_kotojonke
                                                )
                                            "
                                            @change="
                                                data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                shomajsheba2?.janajay_ongshogrohon
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="parent_popup">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.nobojatokke_gift_prodan
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                shomajsheba2?.low_capital_employment_kotojonke
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.vrammoman_school_calu
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    shomajsheba2?.vrammoman_moktob_calu
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        shomajsheba3?.health_worker_training_programs_attendance
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        shomajsheba3?.participated_in_health_care_work
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        shomajsheba4?.shamajik_protishthan_kototi
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        shomajsheba4?.shamajik_protishthan_kototite_kaj_hoyeche
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        shomajsheba4?.new_shamajik_protishthan
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                rastrio1?.rajnoitik_bekti_jogajog_koreche_kotojon
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                rastrio1?.rajnoitik_bekti_jogajog_koreche_kotojonke
                                            )
                                        "
                                        @change="
                                            data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                rastrio1?.proshoshonik_bekti_jogajog_koreche_kotojon
                                            )
                                        "
                                        @change="
                                            data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                rastrio1?.proshoshonik_bekti_jogajog_koreche_kotojonke
                                            )
                                        "
                                        @change="
                                            data_upload(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        average_rastrio2.centrally_announced_political_program
                                                    )
                                                "
                                                @change="
                                                    average_data_upload(
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            average_rastrio2.locally_announced_jonoshova
                                                        )
                                                    "
                                                    @change="
                                                        average_data_upload(
                                                ...
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            average_rastrio2.locally_announced_shomabesh
                                                        )
                                                    "
                                                    @change="
                                                        average_data_upload(
                                                ...
                                                <input
                                                    ...
                                                    :value="
                                                        formatBangla(
                                                            average_rastrio2.locally_announced_michil
                                                        )
                                                    "
                                                    @change="
                                                        average_data_upload(
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_rastrio3.shadhinota_o_jatio_dibosh
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                                ...
                                <td>
                                    <input
                                        ...
                                        :value="
                                            formatBangla(
                                                average_rastrio3.mattrivasha_dibosh
                                            )
                                        "
                                        @change="
                                            average_data_upload(
                                ...
                                <td>
                                    ...
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    rastrio4?.councilor_candidate_elected
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    rastrio4?.member_candidate_elected
                                                )
                                            "
                                            @change="
                                                data_upload(
                                ...
                                <td>
                                    ...
                                    <div class="d-flex">
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    rastrio4?.councilor_candidate_second_position
                                                )
                                            "
                                            @change="
                                                data_upload(
                                        ...
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    rastrio4?.member_candidate_second_position
                                                )
                                            "
                                            @change="
                                                data_upload(
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.national_vote_kendro_increase
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.local_vote_kendro_increase
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.national_vote_kendro_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.local_vote_kendro_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_committee
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_vittik_unit
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_committee_increase
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_vittik_unit_increase
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_committee_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                            ...
                                            <input
                                                ...
                                                :value="
                                                    formatBangla(
                                                        rastrio4?.vote_kendro_vittik_unit_target
                                                    )
                                                "
                                                @change="
                                                    data_upload(
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            :value="
                                                formatBangla(
                                                    rastrio4?.election_management_committee_meeting
                                                )
                                            "
                                            @change="
                                                data_upload(
...
export default {
    ...
    methods: {
        uploaded_data: async function () {
            ...
            if (res.data.status == "success") {
                (this.month = res.data.month),
                    ...
                    (this.expense_category_wise =
                        res.data.expense_category_wise),
        ...
        average_data: async function () {
            // -------------- kormosuci --------------
            this.average_kormosuci.unit_masik_sadaron_sova = this.kormosuci
                ? Math.round(
                      (this.kormosuci.unit_masik_sadaron_sova_uposthiti ?? 0) /
                          (this.kormosuci.unit_masik_sadaron_sova_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.dawati_sova = this.kormosuci
                ? Math.round(
                      (this.kormosuci.dawati_sova_uposthiti ?? 0) /
                          (this.kormosuci.dawati_sova_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.alochona_sova = this.kormosuci
                ? Math.round(
                      (this.kormosuci.alochona_sova_uposthiti ?? 0) /
                          (this.kormosuci.alochona_sova_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.sudhi_somabesh = this.kormosuci
                ? Math.round(
                      (this.kormosuci.sudhi_somabesh_uposthiti ?? 0) /
                          (this.kormosuci.sudhi_somabesh_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.siratunnabi_mahfil = this.kormosuci
                ? Math.round(
                      (this.kormosuci.siratunnabi_mahfil_uposthiti ?? 0) /
                          (this.kormosuci.siratunnabi_mahfil_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.eid_reunion = this.kormosuci
                ? Math.round(
                      (this.kormosuci.eid_reunion_uposthiti ?? 0) /
                          (this.kormosuci.eid_reunion_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.dars = this.kormosuci
                ? Math.round(
                      (this.kormosuci.dars_uposthiti ?? 0) /
                          (this.kormosuci.dars_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.tafsir = this.kormosuci
                ? Math.round(
                      (this.kormosuci.tafsir_uposthiti ?? 0) /
                          (this.kormosuci.tafsir_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.dawati_jonosova = this.kormosuci
                ? Math.round(
                      (this.kormosuci.dawati_jonosova_uposthiti ?? 0) /
                          (this.kormosuci.dawati_jonosova_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.iftar_mahfil_personal = this.kormosuci
                ? Math.round(
                      (this.kormosuci.iftar_mahfil_personal_uposthiti ?? 0) /
                          (this.kormosuci.iftar_mahfil_personal_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.iftar_mahfil_samostic = this.kormosuci
                ? Math.round(
                      (this.kormosuci.iftar_mahfil_samostic_uposthiti ?? 0) /
                          (this.kormosuci.iftar_mahfil_samostic_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.cha_chakra = this.kormosuci
                ? Math.round(
                      (this.kormosuci.cha_chakra_uposthiti ?? 0) /
                          (this.kormosuci.cha_chakra_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.samostic_khawa = this.kormosuci
                ? Math.round(
                      (this.kormosuci.samostic_khawa_uposthiti ?? 0) /
                          (this.kormosuci.samostic_khawa_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.sikkha_sofor = this.kormosuci
                ? Math.round(
                      (this.kormosuci.sikkha_sofor_uposthiti ?? 0) /
                          (this.kormosuci.sikkha_sofor_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.kirat_protijogita = this.kormosuci
                ? Math.round(
                      (this.kormosuci.kirat_protijogita_uposthiti ?? 0) /
                          (this.kormosuci.kirat_protijogita_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.hamd_nat_protijogita = this.kormosuci
                ? Math.round(
                      (this.kormosuci.hamd_nat_protijogita_uposthiti ?? 0) /
                          (this.kormosuci.hamd_nat_protijogita_total ?? 1)
                  )
                : 0;
            this.average_kormosuci.others = this.kormosuci
                ? Math.round(
                      (this.kormosuci.others_uposthiti ?? 0) /
                          (this.kormosuci.others_total ?? 1)
                  )
                : 0;
            // -------------- kormosuci --------------

            // -------------- songothon9 --------------
            this.average_songothon9.word_sura_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.word_sura_boithok_uposthiti ?? 0) /
                          (this.songothon9.word_sura_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.kormoporishod_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.kormoporishod_boithok_uposthiti ?? 0) /
                          (this.songothon9.kormoporishod_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.team_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.team_boithok_uposthiti ?? 0) /
                          (this.songothon9.team_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.word_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.word_boithok_uposthiti ?? 0) /
                          (this.songothon9.word_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.masik_sodosso_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.masik_sodosso_boithok_uposthiti ?? 0) /
                          (this.songothon9.masik_sodosso_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.unit_kormi_boithok = this.songothon9
                ? Math.round(
                      (this.songothon9.unit_kormi_boithok_uposthiti ?? 0) /
                          (this.songothon9.unit_kormi_boithok_total ?? 1)
                  )
                : 0;
            this.average_songothon9.ulama_somabesh = this.songothon9
                ? Math.round(
                      (this.songothon9.ulama_somabesh_uposthiti ?? 0) /
                          (this.songothon9.ulama_somabesh_total ?? 1)
                  )
                : 0;
            this.average_songothon9.jubok_somabesh = this.songothon9
                ? Math.round(
                      (this.songothon9.jubok_somabesh_uposthiti ?? 0) /
                          (this.songothon9.jubok_somabesh_total ?? 1)
                  )
                : 0;
            this.average_songothon9.sromik_somabesh = this.songothon9
                ? Math.round(
                      (this.songothon9.sromik_somabesh_uposthiti ?? 0) /
                          (this.songothon9.sromik_somabesh_total ?? 1)
                  )
                : 0;
            // -------------- songothon9 --------------

            // -------------- proshikkhon1 --------------
            this.average_proshikkhon1.unit_tarbiati_boithok = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.unit_tarbiati_boithok_uposthiti ?? 0) /
                          (this.proshikkhon1.unit_tarbiati_boithok ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.ward_kormi_sikkha_boithok = this
                .proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.ward_kormi_sikkha_boithok_uposthiti ??
                          0) /
                          (this.proshikkhon1.ward_kormi_sikkha_boithok ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.urdhotono_sikkha_shibir = this
                .proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.urdhotono_sikkha_shibir_uposthiti ??
                          0) / (this.proshikkhon1.urdhotono_sikkha_shibir ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.urdhotono_sikkha_boithok = this
                .proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.urdhotono_sikkha_boithok_uposthiti ??
                          0) / (this.proshikkhon1.urdhotono_sikkha_boithok ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.gono_sikkha_boithok = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.gono_sikkha_boithok_uposthiti ?? 0) /
                          (this.proshikkhon1.gono_sikkha_boithok ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.gono_noisho_ibadot = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.gono_noisho_ibadot_uposthiti ?? 0) /
                          (this.proshikkhon1.gono_noisho_ibadot ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.alochona_chokro = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.alochona_chokro_uposthiti ?? 0) /
                          (this.proshikkhon1.alochona_chokro_program ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.darsul_quran = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.darsul_quran_uposthiti ?? 0) /
                          (this.proshikkhon1.darsul_quran_program ?? 1)
                  )
                : 0;
            this.average_proshikkhon1.sohih_tilawat = this.proshikkhon1
                ? Math.round(
                      (this.proshikkhon1.sohih_tilawat_uposthiti ?? 0) /
                          (this.proshikkhon1.sohih_tilawat_program ?? 1)
                  )
                : 0;
            // -------------- proshikkhon1 --------------

            // -------------- rastrio2 --------------
            this.average_rastrio2.centrally_announced_political_program = this
                .rastrio2
                ? Math.round(
                      (this.rastrio2
                          .centrally_announced_political_program_attend ?? 0) /
                          (this.rastrio2
                              .centrally_announced_political_program ?? 1)
                  )
                : 0;
            this.average_rastrio2.locally_announced_jonoshova = this.rastrio2
                ? Math.round(
                      (this.rastrio2.locally_announced_jonoshova_attend ?? 0) /
                          (this.rastrio2.locally_announced_jonoshova ?? 1)
                  )
                : 0;
            this.average_rastrio2.locally_announced_shomabesh = this.rastrio2
                ? Math.round(
                      (this.rastrio2.locally_announced_shomabesh_attend ?? 0) /
                          (this.rastrio2.locally_announced_shomabesh ?? 1)
                  )
                : 0;
            this.average_rastrio2.locally_announced_michil = this.rastrio2
                ? Math.round(
                      (this.rastrio2.locally_announced_michil_attend ?? 0) /
                          (this.rastrio2.locally_announced_michil ?? 1)
                  )
                : 0;
            // -------------- rastrio2 --------------

            // -------------- rastrio3 --------------
            this.average_rastrio3.shadhinota_o_jatio_dibosh = this.rastrio3
                ? Math.round(
                      (this.rastrio3.shadhinota_o_jatio_dibosh_attend ?? 0) /
                          (this.rastrio3
                              .shadhinota_o_jatio_dibosh_total_programs ?? 1)
                  )
                : 0;
            this.average_rastrio3.bijoy_dibosh = this.rastrio3
                ? Math.round(
                      (this.rastrio3.bijoy_dibosh_attend ?? 0) /
                          (this.rastrio3.bijoy_dibosh_total_programs ?? 1)
                  )
                : 0;
            this.average_rastrio3.mattrivasha_dibosh = this.rastrio3
                ? Math.round(
                      (this.rastrio3.mattrivasha_dibosh_attend ?? 0) /
                          (this.rastrio3.mattrivasha_dibosh_total_programs ?? 1)
                  )
                : 0;
            this.average_rastrio3.others = this.rastrio3
                ? Math.round(
                      (this.rastrio3.others_attend ?? 0) /
                          (this.rastrio3.others_total_programs ?? 1)
                  )
                : 0;
            // -------------- rastrio3 --------------
        },
        ...
        bm_categoty_amount: function (bm_cat_id) {
            ...
            if (this.bm_cat_wise != null) {
                ...
                const element = this.bm_cat_wise.find((el) => {
                    if (
                        el.ward_bm_income_category &&
                        el.ward_bm_income_category.id == bm_cat_id
                    ) {
                        return el;
                    }
                });
        ...
        expense_categoty_amount: function (expense_cat_id) {
            ...
            if (this.expense_cat_wise != null) {
                ...
                const element = this.expense_cat_wise.find((element) => {
                    if (
                        element.ward_bm_expense_category &&
                        element.ward_bm_expense_category.id == expense_cat_id
                    ) {
                        return element;
                    }
                });
